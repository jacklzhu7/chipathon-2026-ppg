...
N -180 -360 -180 -330 {lab=Vb4
}
N -190 -360 -180 -360 {lab=Vb4
}
...
N -40 -510 210 -510 {lab=VDD}
N 80 -530 80 -510 {lab=VDD}
N 210 -440 210 -410 {lab=n6}
...
N -40 -510 -40 -440 {lab=VDD}
N 210 -510 310 -510 {lab=VDD}
N 150 -480 170 -480 {lab=VDD}
N 170 -510 170 -480 {lab=VDD}
N 290 -480 310 -480 {lab=VDD}
N 290 -510 290 -480 {lab=VDD}
N 160 -450 310 -450 {lab=n6}
N 210 -450 210 -440 {lab=n6}
N 150 -450 160 -450 {lab=n6}
N 70 -480 110 -480 {lab=Voutp}
N 350 -480 390 -480 {lab=Voutn}
N -260 -175 -220 -175 {lab=#net1}
N -260 -175 -260 -130 {lab=#net1}
N -220 -130 -190 -130 {lab=0}
N -190 -130 -190 -90 {lab=0}
N -120 -130 -80 -130 {lab=#net1}
N -40 -130 -10 -130 {lab=0}
N -10 -130 -10 -80 {lab=0}
N -40 -80 -10 -80 {lab=0}
N -40 -100 -40 -80 {lab=0}
N -220 -80 -40 -80 {lab=0}
N -190 -90 -190 -80 {lab=0}
N -120 -190 -120 -130 {lab=#net1}
N -220 -190 -120 -190 {lab=#net1}
N -300 -140 -260 -140 {lab=#net1}
N -300 -80 -220 -80 {lab=0}
N -220 -100 -220 -80 {lab=0}
N -40 -220 -40 -160 {lab=Vbias}
...
C {lab_pin.sym} 620 -450 0 1 {name=p7 sig_type=std_logic lab=Vb4
}
C {lab_pin.sym} 620 -330 0 1 {name=p8 sig_type=std_logic lab=Vb1
}
C {vdd.sym} 80 -530 0 0 {name=l28 lab=VDD
}
...
C {vsource.sym} -240 -490 0 0 {name=V4 value=1.7 savecurrent=false
}
C {gnd.sym} -240 -460 0 0 {name=l21 lab=0
}
C {lab_pin.sym} -250 -550 0 0 {name=p9 sig_type=std_logic lab=Vb1
}
C {vsource.sym} -160 -490 0 0 {name=V5 value=1.5 savecurrent=false
}
...
C {lab_pin.sym} -190 -360 0 0 {name=p13 sig_type=std_logic lab=Vb4
}
...
C {ngspice_get_value.sym} 210 -430 0 0 {name=r10 node=i(@m.xm3.m0[id])
descr="I="
}
...
C {vdd.sym} 240 -380 0 0 {name=l14 lab=VDD
}
C {lab_pin.sym} 390 -480 0 1 {name=p19 sig_type=std_logic lab=Voutn
}
C {lab_pin.sym} 70 -480 0 0 {name=p20 sig_type=std_logic lab=Voutp
}
C {lab_pin.sym} 210 -430 0 0 {name=p21 sig_type=std_logic lab=n6
}
C {symbols/pfet_03v3.sym} 130 -480 0 0 {name=M15
L=0.28u
W=30u
nf=3
m=1
...
C {symbols/pfet_03v3.sym} 330 -480 0 1 {name=M1
L=0.28u
W=30u
nf=3
m=1
...
C {symbols/pfet_03v3.sym} 80 -250 0 0 {name=M2
L=0.28u
W=3.45u
nf=1
m=1
...
C {symbols/pfet_03v3.sym} 330 -250 0 1 {name=M6
L=0.28u
W=3.45u
nf=1
m=1
...
C {symbols/nfet_03v3.sym} 560 -190 0 1 {name=M7
L=0.28u
W=6.6u
nf=2
m=1
...
C {symbols/nfet_03v3.sym} 700 -190 0 0 {name=M13
L=0.28u
W=6.6u
nf=2
m=1
...
C {symbols/nfet_03v3.sym} 560 -90 0 1 {name=M14
L=0.28u
W=13u
nf=4
m=1
...
C {/foss/pdks/ciel/gf180mcu/versions/7b70722e33c03fcb5dabcf4d479fb0822d9251c9/gf180mcuD/libs.tech/xschem/symbols/nfet_03v3.sym} 700 -90 0 0 {name=M5
L=0.28u
W=13u
nf=4
m=1
...
C {vsource.sym} -300 -110 0 0 {name=V8 value=1.8 savecurrent=false}
C {gnd.sym} -300 -80 0 0 {name=l3 lab=0}
C {symbols/nfet_03v3.sym} -240 -130 0 0 {name=M4
L=3u
W=1.1u
nf=1
m=1
...
C {symbols/nfet_03v3.sym} -60 -130 0 0 {name=M16
L=3u
W=1.1u
nf=1
m=1
...
C {ngspice_get_value.sym} -220 -190 0 0 {name=r11 node=i(@m.xm4.m0[id])
descr="I="
}
C {ngspice_get_value.sym} -40 -180 0 0 {name=r12 node=i(@m.xm16.m0[id])
descr="I="
}
