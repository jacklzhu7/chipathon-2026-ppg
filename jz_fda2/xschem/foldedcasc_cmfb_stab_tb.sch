...
N 210 -420 210 -410 {lab=n6}
N 210 -440 210 -420 {lab=n6}
N 620 -750 620 -700 {lab=#net1}
N 680 -750 720 -750 {lab=n6}
N 780 -750 810 -750 {lab=Vbias}
...
C {vsource.sym} -200 -670 0 0 {name=V2 value="1.7" savecurrent=false
}
...
C {vsource.sym} -120 -670 0 0 {name=V3 value="1.7" savecurrent=false
}
...
C {vsource.sym} -240 -490 0 0 {name=V4 value=1.4 savecurrent=false
}
...
C {symbols/pfet_03v3.sym} 130 -480 0 0 {name=M13
L=0.28u
W=30u
nf=1
m=1
...
C {symbols/pfet_03v3.sym} 330 -480 0 1 {name=M14
L=0.28u
W=30u
nf=1
m=1
...
C {code_shown.sym} 310 -1110 0 0 {name=SPICE only_toplevel=false value=".option savecurrents
.save all
.control
op
write oppoints.raw
...
C {vsource.sym} 620 -670 0 1 {name=V9 value="AC 1" savecurrent=false
}
C {capa.sym} 650 -750 1 1 {name=C2
m=1
value=1G
footprint=1206
device="ceramic capacitor"}
C {gnd.sym} 620 -640 0 1 {name=l16 lab=0
}
C {ind.sym} 750 -750 1 0 {name=L18
m=1
value=1G
footprint=1206
device=inductor}
C {lab_pin.sym} 810 -750 0 1 {name=p23 sig_type=std_logic lab=Vbias
}
C {lab_pin.sym} 700 -750 1 1 {name=p26 sig_type=std_logic lab=Voutn
}
