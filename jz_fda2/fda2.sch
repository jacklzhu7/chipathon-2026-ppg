...
N 40 -270 80 -270 {lab=#net3}
N -20 -300 80 -300 {lab=#net4}
...
N 430 -440 430 -340 {lab=#net5}
N 430 -440 490 -440 {lab=#net5}
...
device=resistor
m=1}
C {vsource.sym} 40 -240 0 0 {name=V5 value="1.2 AC 0.5" savecurrent=false
}
C {gnd.sym} 40 -210 0 0 {name=l31 lab=0
}
C {vsource.sym} -20 -270 0 0 {name=V6 value="1.2 AC -0.5" savecurrent=false
}
C {gnd.sym} -20 -240 0 0 {name=l7 lab=0
}
