...
C {devices/lab_pin.sym} 60 -340 2 1 {name=g0 lab=iref}
C {devices/lab_pin.sym} 100 -340 2 0 {name=b0 lab=GND}
...
C {symbols/nfet_03v3.sym} 1010 -450 0 0 {name=XO6
L=1u
W=2.10u
nf=1
m=1
...
C {devices/lab_pin.sym} 990 -450 2 1 {name=g6 lab=iref}
C {devices/lab_pin.sym} 1030 -480 0 0 {name=o6 lab=Ibias5u}
C {devices/lab_pin.sym} 1030 -420 0 0 {name=s6 lab=GND}
C {devices/lab_pin.sym} 1030 -450 2 0 {name=b6 lab=GND}
...
C {symbols/pfet_03v3.sym} 510 -460 0 0 {name=M2
L=0.28u
W=0.22u
nf=1
m=1
