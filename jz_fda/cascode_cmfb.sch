...
N 640 -460 640 -440 {lab=Vtail
}
N 640 -440 860 -440 {lab=Vtail
}
N 860 -470 860 -440 {lab=Vtail
}
N 640 -470 640 -460 {lab=Vtail
}
N 760 -440 760 -390 {lab=Vtail
}
...
spice_ignore=short}
N 1350 -890 1350 -830 {lab=VDD}
N 860 -890 1180 -890 {lab=VDD}
N 1180 -890 1280 -890 {lab=VDD}
N 1350 -640 1400 -640 {lab=Vb3}
N 1230 -800 1310 -800 {lab=#net1}
N 1190 -890 1190 -830 {lab=VDD}
N 1280 -260 1280 -220 {lab=0
}
N 1280 -290 1310 -290 {lab=0
}
N 1310 -290 1310 -240 {lab=0
}
N 1280 -240 1310 -240 {lab=0
}
N 670 -300 670 -180 {lab=Vbias}
N 670 -180 990 -180 {lab=Vbias}
N 990 -290 990 -180 {lab=Vbias}
N 1160 -290 1240 -290 {lab=Vbias}
N 1070 -290 1160 -290 {lab=Vbias}
N 990 -290 1070 -290 {lab=Vbias}
N 1070 -410 1150 -410 {lab=Vsense}
N 1390 -410 1460 -410 {lab=#net2}
N 1210 -380 1350 -380 {lab=Vtail2}
N 1280 -380 1280 -320 {lab=Vtail2}
N 1350 -770 1350 -440 {lab=Vb3}
N 1190 -770 1190 -440 {lab=#net1}
N 1190 -380 1210 -380 {lab=Vtail2}
N 1280 -890 1350 -890 {lab=VDD}
N 1140 -800 1190 -800 {lab=VDD}
N 1140 -890 1140 -800 {lab=VDD}
N 1350 -800 1390 -800 {lab=VDD}
N 1390 -890 1390 -800 {lab=VDD}
N 1350 -890 1390 -890 {lab=VDD}
N 1190 -410 1350 -410 {lab=0}
N 1270 -800 1270 -730 {lab=#net1}
N 1190 -730 1270 -730 {lab=#net1}
...
.save all
.save @m.xm13.m0[gm] @m.xm15.m0[gm] @m.xm20.m0[gm] @m.xm4.m0[gm]
.save @m.xm13.m0[gds] @m.xm15.m0[gds] @m.xm19.m0[gds] @m.xm20.m0[gds] @m.xm6.m0[gds] @m.xm4.m0[gds]
.ic v(Vb3)=2.4
.control
op
write oppoints.raw
...
C {lab_pin.sym} 760 -420 0 0 {name=p26 sig_type=std_logic lab=Vtail
}
...
spice_ignore=true}
C {symbols/pfet_03v3.sym} 1330 -800 0 0 {name=M1
L=0.5u
W=2u
nf=1
m=1
...
C {symbols/nfet_03v3.sym} 1170 -410 0 0 {name=M4
L=0.28u
W=1.4u
nf=1
m=1
...
C {symbols/nfet_03v3.sym} 1370 -410 0 1 {name=M5
L=0.28u
W=1.4u
nf=1
m=1
...
C {lab_pin.sym} 1070 -410 0 0 {name=p3 sig_type=std_logic lab=Vsense
}
C {vsource.sym} 1460 -380 0 0 {name=V5 value=1.7 savecurrent=false
}
C {gnd.sym} 1460 -350 0 0 {name=l4 lab=0
}
C {lab_pin.sym} 1400 -640 0 1 {name=p2 sig_type=std_logic lab=Vb3
}
C {symbols/pfet_03v3.sym} 1210 -800 0 1 {name=M6
L=0.5u
W=2u
nf=1
m=1
...
C {gnd.sym} 1280 -220 0 0 {name=l5 lab=0
}
C {symbols/nfet_03v3.sym} 1260 -290 0 0 {name=M7
L=0.28u
W=2.6u
nf=1
m=1
...
C {ngspice_get_value.sym} 1200 -450 0 0 {name=r4 node=@m.xm4.m0[gm]
descr="gm="
}
C {ngspice_get_value.sym} 1200 -480 0 0 {name=r5 node=@m.xm4.m0[gds]
descr="gds="
}
C {ngspice_get_value.sym} 1190 -580 0 0 {name=r6 node=i(@m.xm4.m0[id])
descr="I="
}
C {ngspice_get_value.sym} 1350 -580 0 0 {name=r7 node=i(@m.xm5.m0[id])
descr="I="
}
C {ngspice_get_value.sym} 1210 -750 0 0 {name=r8 node=@m.xm6.m0[gds]
descr="gds="
}
C {gnd.sym} 1280 -410 0 0 {name=l1 lab=0
}
C {ngspice_get_value.sym} 1320 -330 0 0 {name=r9 node=i(@m.xm7.m0[id])
descr="I="
}
C {lab_pin.sym} 1280 -360 0 0 {name=p8 sig_type=std_logic lab=Vtail2
}
C {vsource.sym} 950 -450 0 0 {name=V6 value="1.2 AC -0.5" savecurrent=false
}
C {gnd.sym} 950 -420 0 0 {name=l6 lab=0
}
C {vsource.sym} 950 -450 0 0 {name=V9 value="1.2 AC -0.5" savecurrent=false
}
C {gnd.sym} 950 -420 0 0 {name=l7 lab=0
}
C {vsource.sym} 950 -450 0 0 {name=V10 value="1.2 AC -0.5" savecurrent=false
}
C {gnd.sym} 950 -420 0 0 {name=l8 lab=0
}
